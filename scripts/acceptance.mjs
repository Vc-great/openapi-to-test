...
const commandCases = [
  ...
  { id: "GEN-004", suite: "generators", feature: "SWR generation", ...openapiCommand("generate", "--config", "openapi.config.ts", "--json"), expected: "generation succeeds", assert: (r) => r.exitCode === 0 && parseJson(r.stdout)?.success === true },
