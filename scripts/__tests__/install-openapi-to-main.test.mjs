...
test("committed generated workspace can bootstrap without ignored provenance", () => {
  const generated = `# Generated by scripts/install-openapi-to-main.mjs\n# Source HEAD: ${head}\n# Consumer-only current-main test settings.\noverrides:\n`;
  assert.equal(isFreshCloneGeneratedWorkspaceCandidate({ contents: generated, provenance: undefined, tracked: true, status: "" }), true);
  assert.equal(canBootstrapGeneratedWorkspace({ contents: generated, provenance: undefined, tracked: true, status: "", canonicalContents: generated }), true);
  assert.equal(canBootstrapGeneratedWorkspace({ contents: generated, provenance: undefined, tracked: true, status: "", canonicalContents: `${generated}custom:\n` }), false);
  assert.equal(isFreshCloneGeneratedWorkspaceCandidate({ contents: generated, provenance: undefined, tracked: false, status: "" }), false);
  assert.equal(isFreshCloneGeneratedWorkspaceCandidate({ contents: generated, provenance: undefined, tracked: true, status: " M pnpm-workspace.yaml" }), false);
  assert.equal(isFreshCloneGeneratedWorkspaceCandidate({ contents: generated, provenance: { schemaVersion: 1 }, tracked: true, status: "" }), false);
  assert.equal(isFreshCloneGeneratedWorkspaceCandidate({ contents: "overrides:\n", provenance: undefined, tracked: true, status: "" }), false);
});
